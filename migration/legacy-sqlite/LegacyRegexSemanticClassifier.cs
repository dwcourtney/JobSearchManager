...
public sealed class LegacyRegexSemanticClassifier : IConceptMatcher
{
    ...
    public LegacyRegexSemanticClassifier(SqliteSemanticRuleStore store, JobConceptCatalog catalog)
    {
        _store = store;
    ...
    internal LegacyRegexSemanticClassifier(SemanticRulesSnapshot snapshot, JobConceptCatalog catalog, SemanticRulePolicy policy)
    {
        _catalog = catalog;
        _policy = policy;
...
public sealed class RegexTelemetryFlushService(
    LegacyRegexSemanticClassifier classifier,
