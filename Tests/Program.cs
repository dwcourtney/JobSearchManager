...
static async Task TestLlmClassifierContractAsync()
{
    ...
    var payload = JsonSerializer.Serialize(new {
        ...
        serviceVersion = "0.5.0", protocolVersion = "4", revision = new string('a', 40),
        ...
        modelType = "generative-llm", modelId = "meta-llama/Llama-3.1-8B-Instruct",
        modelTag = "llama3.1:8b-instruct-q4_K_M",
        modelDigest = "sha256:46e0c10c039e019119339687c3c1757cc81b9da49709a3b3924863ba87ca666e",
...
static Task TestLlmFixtureMetricsAsync()
{
    ...
    var predictions = cases.Select(item => new LlmEvaluationService.Prediction(item,
        new LlmClassifierResponse(true, item.FixtureId, item.Title, item.Description.Length,
            "0.5.0", "4", new string('a', 40), true, 1, "NVIDIA GeForce GTX 1070",
