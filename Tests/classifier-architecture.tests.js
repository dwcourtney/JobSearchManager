...
assert.match(classifier, /"v1": \("phase3-zero-shot-v1"/);
assert.match(classifier, /"independent-evidence": \("phase3-prompt-independent-evidence-v3"/);
assert.match(classifier, /"role-ownership": \("phase3-prompt-role-ownership-v1"/);
assert.match(classifier, /"positive-verification": \("phase3-prompt-positive-verification-v1"/);
assert.match(classifier, /CLASSIFIER_PROMPT_VARIANT/);
