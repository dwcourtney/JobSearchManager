...
if (args is ["--freeze-salary-fixtures", var salaryFixtures])
{
    SalaryMigrationTests.Freeze(salaryFixtures);
    return;
}
...
if (args is ["--freeze-work-authorization-fixtures", var authorizationFixtures])
{
    WorkAuthorizationMigrationTests.Freeze(authorizationFixtures);
    return;
}
