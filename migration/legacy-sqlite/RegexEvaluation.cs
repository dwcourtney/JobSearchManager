...
public sealed class RegexEvaluationService
{
    ...
    private readonly IConceptMatcher _classifier;
    ...
    public RegexEvaluationService(IHostEnvironment environment, IConceptMatcher classifier,
    ...
    internal RegexEvaluationService(string corpusPath, IConceptMatcher classifier,
        SqliteSemanticRuleStore store, JobConceptCatalog catalog)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            using (var candidateStore = new SqliteSemanticRuleStore(databasePath, _catalog, _store.Policy))
            {
                ...
                var candidateClassifier = new LegacyRegexSemanticClassifier(candidateStore, _catalog);
